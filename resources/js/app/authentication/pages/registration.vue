<template>
    ...
    <form @submit.prevent="registrationApi()">
        ...
        <div class="mb-3 w-full block">
            ...
            <input id="name" type="text" name="name" v-model="formData.name" class="text-xs font-medium w-full border border-gray-100 bg-gray-100 block min-h-[45px] max-h-[45px] rounded-md outline-0 ring-0 focus-within:ring-3 ring-blue-400 duration-500 px-4 shadow-inner" autocomplete="off" />
        ...
        <div class="mb-3 w-full block">
            ...
            <input id="password-confirmation" type="password" name="password_confirmation" v-model="formData.password_confirmation" class="text-xs font-medium w-full border border-gray-100 bg-gray-100 block min-h-[45px] max-h-[45px] rounded-md outline-0 ring-0 focus-within:ring-3 ring-blue-400 duration-500 px-4 shadow-inner" autocomplete="off" />
        ...
        <div class="mb-5 w-full block">
            <button type="submit" class="min-w-[180px] text-sm font-medium bg-blue-400 duration-500 hover:bg-blue-700 text-white px-10 rounded-md min-h-[45px] max-h-[45px] cursor-pointer inline-flex justify-center items-center" v-if="!loading">
                Registration
            </button>
            <button type="submit" class="min-w-[180px] text-sm font-medium bg-blue-400 duration-500 hover:bg-blue-700 text-white px-10 rounded-md min-h-[45px] max-h-[45px] cursor-pointer inline-flex justify-center items-center" v-if="loading">
