<template>
    ...
    <form @submit.prevent="forgotApi()">
        ...
        <div class="mb-5 w-full block">
            <button type="submit" class="min-w-[110px] text-sm font-medium bg-blue-400 duration-500 hover:bg-blue-700 text-white px-10 rounded-md min-h-[45px] max-h-[45px] cursor-pointer" v-if="!loading">
                Send
            </button>
            <button type="button" class="min-w-[110px] text-sm font-medium bg-blue-400 duration-500 hover:bg-blue-700 text-white px-10 rounded-md min-h-[45px] max-h-[45px] cursor-pointer" v-if="loading">
